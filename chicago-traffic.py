...
def main(path: str):
    """Ejecuta el flujo principal: descarga de datos y guardado como CSV.
    Consulta a la API de accidentes de tráfico
    Genera archivo CSV y lo sube al bucket de IBM COS
    Sirve para ejecutar el proceso de scraping y almacenamiento."""
    ...
    if not df.empty:
        ...
        # Guardar CSV con los datos obtenidos
